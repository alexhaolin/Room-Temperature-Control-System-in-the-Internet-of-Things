...
public class MqttClientConnector implements MqttCallback {
	...
	public void messageArrived(String topic, MqttMessage msg) throws Exception {
		...
		MqttClientConnector mcc = new MqttClientConnector(null, true);
		mcc.connect();
		mcc.publishMessage("ActuatorData", 2, payload.getBytes());
		_Logger.info("Message arrived: " + topic + ", " + msg.getId() + ". Message: " + payload);
