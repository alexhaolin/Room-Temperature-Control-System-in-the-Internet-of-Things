...
class CoapClientConnector:
    ...
    def __init__(self):
        ...
        self.pollCycleSecs  = int(self.config.getProperty(ConfigConst.DEVICE, ConfigConst.POLL_CYCLES_KEY))
        self.enableEmulator = self.config.getProperty(ConfigConst.DEVICE, ConfigConst.ENABLE_EMULATOR_KEY)
